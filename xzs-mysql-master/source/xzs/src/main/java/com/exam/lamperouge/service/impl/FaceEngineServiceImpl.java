...
import com.exam.lamperouge.dto.ProcessInfo;
import com.exam.lamperouge.factory.FaceEngineFactory;
import com.exam.lamperouge.repository.MybatisUserFaceInfoMapper;
import com.exam.lamperouge.service.FaceEngineService;
...
public class FaceEngineServiceImpl implements FaceEngineService {
    ...
    public byte[] extractFaceFeature(ImageInfo imageInfo) throws InterruptedException {
        ...
        try {
            ...
            /*// 激活引擎
            int activeCode = faceEngine.activeOnline("APP_ID:5JntyMreSZjQ98meoCZmZ79Wf38Pi1kB6p66NE6uJsBv", "SDK_KEY:4rsWTEW9AViiFmKt6CfKTH1C7t69ApTfwgsEoPne7jio");
            ...
            int ftInitCode = faceEngine.init(ftEngineCfg);*/
            ...
            if (CollectionUtil.isNotEmpty(faceInfoList)) {
                ...
                System.out.println("人脸特征不为空");
                return faceFeature.getFeatureData();
            }
        } catch (Exception e) {
            System.out.println("提取人脸特征时发生错误");
            logger.error("", e);
        } finally {
            if (faceEngine != null) {
                //释放引擎对象
                System.out.println("提取人脸特征完成");
                faceEngineObjectPool.returnObject(faceEngine);
            }
